...
public class FileSystemUtilsTestCase {
	...
	public static FileSystemUtils mockFileSystemUtils2(final int exitCode, final String lines, final String cmd)
		...
		}).when(mockInstance).openProcess(any(String[].class));
		return mockInstance;
	}
	...
	@Test
	public void testGetFreeSpaceWindows_String_EmptyResponse() throws IOException {
		final String lines = "";
		final FileSystemUtils fsu = FileSystemUtilsTestCase.mockFileSystemUtils1(0, lines);
		try {
	...
	public void testGetFreeSpaceUnix_String_EmptyResponse() throws IOException {
		final String lines = "";
		final FileSystemUtils fsu = FileSystemUtilsTestCase.mockFileSystemUtils1(0, lines);
		try {
	...
	@Test
	public void testGetFreeSpaceUnix_String_InvalidResponse1() throws IOException {
		final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n"
	...
	@Test
	public void testGetFreeSpaceUnix_String_InvalidResponse2() throws IOException {
		final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n"
	...
	@Test
	public void testGetFreeSpaceUnix_String_InvalidResponse3() throws IOException {
		final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n"
	...
	@Test
	public void testGetFreeSpaceUnix_String_InvalidResponse4() throws IOException {
		final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n"
				+ "xxx-yyyyyyy-zzz:/home/users/s";
		final FileSystemUtils fsu = FileSystemUtilsTestCase.mockFileSystemUtils1(0, lines);
		try {

...
/**
 * On JUnit Test Case for {@link TeeOutputStream}.
 */
public class TeeOutputStreamTest {

	/**
	 * Tests that the branch {@code OutputStream} is closed when closing the main
	 * {@code OutputStream} throws an exception on {@link TeeOutputStream#close()}.
	 */
	@Test
	public void testIOExceptionOnCloseBranch() throws IOException, IOException {
	...
	/**
	 * Tests that the main {@code OutputStream} is closed when closing the branch
	 * {@code OutputStream} throws an exception on {@link TeeOutputStream#close()}.
	 */
	@Test
	public void testIOExceptionOnClose() throws IOException, IOException {
		final ProxyOutputStream badOs = ThrowOnCloseOutputStream.mockProxyOutputStream1();
		final ByteArrayOutputStream goodOs = mock(ByteArrayOutputStream.class);
